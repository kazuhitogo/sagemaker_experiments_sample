...
from tensorflow.keras.layers import Input,Conv2D,LeakyReLU,Dense,Reshape,Flatten,Dropout,BatchNormalization,Conv2DTranspose,MaxPool2D,PReLU
...
def train(train_x,train_y,valid_x,valid_y,epochs,model_dir):
    ...
    save_model_path = os.path.join(model_dir, '0001.h5')
